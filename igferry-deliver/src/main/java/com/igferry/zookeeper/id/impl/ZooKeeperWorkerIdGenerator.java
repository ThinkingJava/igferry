package com.igferry.zookeeper.id.impl;
...
@Slf4j
public class ZooKeeperWorkerIdGenerator implements WorkerIdGenerator {
    ...
    private String PATH_FOREVER;
    private String PROP_PATH;

    private ZookeeperConfig zookeeperConfig;

    public ZooKeeperWorkerIdGenerator(String ip, String port, String connectionString, ZookeeperConfig zookeeperConfig) {
        this.ip = ip;
        this.port = port;
        this.listenAddress = ip + ":" + port;
        this.connectionString = connectionString;
        this.zookeeperConfig = zookeeperConfig;
        this.PATH_FOREVER = zookeeperConfig.getPrefixZkPath()+zookeeperConfig.getPathForever();
        this.PROP_PATH = zookeeperConfig.getPropPath();
    }
    ...
    */
    ...
    private void doService(CuratorFramework curator) {
        ScheduledUploadData(curator, zk_AddressNode);// /forever/ip:port-000000001
    }
